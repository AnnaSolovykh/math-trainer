...
export default function TrainerPageContent() {
    ...
    switch(mode) {
      ...
      case 'divide': 
        return { 
          emoji: '➗', 
          title: 'Деление', 
          bgClass: 'bg-gradient-to-r from-emerald-400 to-emerald-500', // ИЗУМРУДНЫЙ
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 flex flex-col p-3 sm:p-4 lg:p-6 relative overflow-hidden">
      ...
      {/* Нижняя панель - фиксированная позиция на мобиле */}
      <div className="mt-4 sm:mt-6 relative z-10 space-y-3 sm:space-y-4">
        ...
        {/* Мотивационное сообщение - CONDITIONAL RENDERING */}
        <div className="text-center">
